class map_container extends Phaser.GameObjects.Container 
{
	...
	constructor(scene, map_no, x_dim, y_dim) 
	{
		...
		code_box_color_array[3] = 0x0066FF; //Underworld 0xEFE4B0 0x0066FF
		...
		code_box_color_array[13] = 0xCC9900;//0xCC9933;
		code_box_color_array[14] = 0xCC6600;//0xCC9933;
